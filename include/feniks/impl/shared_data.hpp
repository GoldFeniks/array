...
namespace feniks {
    ...
    namespace _impl {
        ...
        struct strides {
            ...
            template<size_t... I>
            static shared_data<T, ST> make(const S&... sizes, std::index_sequence<I...>) {
        ...
        public:
            ...
            void allocate(const S&... sizes) {
                ...
                _strides = _impl::strides<ST, DT, S...>::make(sizes...);
            }
            ...
            shared_sized_data<T, sizeof...(S), ST, DT> reshape(S... sizes) const {
                ...
                return shared_sized_data<T, sizeof...(S), ST, DT>(_data,
                                                                  sizes_type(new ST[sizeof...(S)] { size_type(sizes)... }), _impl::strides<ST, DT, S...>::make(sizes...));
            }
